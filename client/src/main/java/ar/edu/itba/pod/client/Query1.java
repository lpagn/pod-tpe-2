...
public class Query1 {
    ...
    public static void main(String [] args) throws ExecutionException, InterruptedException, IOException {
        ...
        String s = QueryUtils.now() + " Query1: - Inicio de la lectura del archivo\n";
        ...
        String t = QueryUtils.now() + " Query1: - Fin de la lectura del archivo\n";
        timeStampWriter.append(t);

        // CompletableFuture object construction
        String u = QueryUtils.now() + " Query1: - Inicio del trabajo map/reduce\n";
        ...
        String v = QueryUtils.now() + " Query1: - Fin del trabajo map/reduce\n";
